...
enum syntaxKind { INTEGER_LITERAL, FLOAT_LITERAL, STRING_LITERAL, IDENTIFIER, KEYWORD_IF, KEYWORD_WHILE, KEYWORD_FOR, KEYWORD_FN,
                    ...
                    PLUS_PLUS,DASH_DASH,PLUS_EQUALS, DASH_EQUALS, SLASH_EQUALS, STAR_EQUALS, EQUALS_EQUALS, LESS_THAN_EQUALS, GREATER_THAN_EQUALS, 
...
class Lexer
{
    ...
    public:
        Lexer(string DFAConfigFile, string srcFile);
